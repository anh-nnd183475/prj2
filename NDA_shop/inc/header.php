...
<body>
  <div class="wrap">
		<div class="header_top" >
			<div class="logo">
				<a href="index.php">
				 <img style="max-height: 200px" src="assets/logo2.png" alt="logo" /></a>
			</div>
			...
			?>
		   <div class="login" style= " text-align:center; font-size: 20px; background-color:#EEE9E9">
			<?php
			$login_check = Session::get('customer_login'); 
			if($login_check==false){
				echo '<a href="login.php">Tài khoản</a></div>';
			}else{
